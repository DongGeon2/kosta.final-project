...
<!-- banner section -->
    ...
    <!-- about section -->
    <section class="w3l-features-photo-7 py-5" id="about">
        <div class="container py-md-5 py-4">
            <div class="row w3l-features-photo-7_top align-items-center">
                <div class="col-lg-6 w3l-features-photo-7_top-left pl-lg-4">
                    ...
                    <p>Aermentum dolor molestie vel id neque. Donec sed tempus enim, a congue
                        risus. Pellen orci urna. In et augue ornare,
                        tempor massa in, roin a diam et dui tesqu.
                    </p>
                    <div class="row feat_top mt-4 pt-lg-3">
                        <div class="col-6 w3l-features-photo-7-box">
                            ...
                            <h5 class="w3l-feature-text mb-2 mt-3">Our Mission</h5>
                            <p>In a diam et dui, orci urna. Donec sed tempus enims.</p>
                        </div>
                        <div class="col-6 w3l-features-photo-7-box">
                            <img src="assets/images/s1.png" alt="" class="img-fluid">
                            <h5 class="w3l-feature-text mb-2 mt-3">Our Vision</h5>
                            <p>Et dui elit, orci urnavel id neque. Donec in a diam.</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- feature section -->
    <section class="w3l-feature-8" id="features">
        <div class="features-main pb-5">
            <div class="container py-md-5 py-4">
                <div class="row features text-center py-xl-2">
                    <div class="col-lg-3 col-sm-6 feature-1">
                        <div class="feature-body">
                            ...
                            <div class="feature-info mt-4">
                                ...
                                <a href="#about" class="btn btn-style btn-style-normal mt-4">Our Venues</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 feature-2 mt-sm-0 mt-5">
                        <div class="feature-body">
                            ...
                            <div class="feature-info mt-4">
                                <a href="#about">
                                    <h3 class="feature-titel">DJ Music</h3>
                                </a>
                                <p class="feature-text">Lorem ipsum dolor sit amet consectetur adipis</p>
                                <a href="#about" class="btn btn-style btn-style-normal mt-4">Music Lists</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 feature-3 mt-lg-0 mt-5">
                        <div class="feature-body">
                            ...
                            <div class="feature-info mt-4">
                                <a href="#about">
                                    <h3 class="feature-titel">Food & Drinks</h3>
                                </a>
                                <p class="feature-text">Lorem ipsum dolor sit amet consectetur adipis</p>
                                <a href="#about" class="btn btn-style btn-style-normal mt-4">Menu Lists</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 feature-3 mt-lg-0 mt-5">
                        <div class="feature-body">
                            ...
                            <div class="feature-info mt-4">
                                <a href="#about">
                                    <h3 class="feature-titel">Fireworks</h3>
                                </a>
                                <p class="feature-text">Lorem ipsum dolor sit amet consectetur adipis</p>
                                <a href="#about" class="btn btn-style btn-style-normal mt-4">Our Parties</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="w3l-homeblock4 py-5" id="video">
        <div class="video-recipe py-md-5 py-4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 align-self">
                        <div class="waviy mb-sm-3 mb-2">
                            <span style="--i:1">A</span>
                    ...
                    <div class="col-lg-6 mt-lg-0 mt-sm-5 mt-4">
                        <div class="row">
                            <div class="col-md-6 p-md-0">
                                <iframe src="https://player.vimeo.com/video/195905200" frameborder="0"
                                    allow="autoplay; fullscreen" allowfullscreen></iframe>
                            </div>
                            <div class="col-md-6 mt-md-0 mt-4">
                                <iframe src="https://player.vimeo.com/video/147318200" frameborder="0"
                                    allow="autoplay; fullscreen" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container py-md-5 py-4">
                ...
                <div class="covers14-text text-center mx-auto py-lg-5" style="max-width:780px">
                    ...
                    <p class="mt-3 sub-title">Sed ut perspiciatis unde omnis iste natus error sit olupt atem accusantium
                        ...
                        totam rem aperiam.</p>
                    <a href="#about" class="btn btn-style mt-5">Let's Get Started !</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- services section -->
    <section class="w3l-content-11-main position-relative" id="services">
            ...
            <div class="container py-md-5 py-4">
                ...
                <div class="content-sec-11">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="services-single d-flex p-sm-5 p-4">
                                ...
                                <div class="services-content">
                                    <h5><a href="#services">Awesome Design</a></h5>
                        ...
                        <div class="col-lg-6">
                            <div class="services-single d-flex p-sm-5 p-4">
                                ...
                                <div class="services-content">
                                    <h5><a href="#services">Organised</a></h5>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean egestas magna at
                                        porttitor vehicula nullam augue ipsum dolor.</p>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="services-single d-flex p-sm-5 p-4 mb-lg-0">
                                ...
                                <div class="services-content">
                                    <h5><a href="#services">We are the best</a></h5>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean egestas magna at
                                        porttitor vehicula nullam augue ipsum dolor.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="services-single d-flex p-sm-5 p-4 mb-0">
                                ...
                                <div class="services-content">
                                    <h5><a href="#services">Creativity</a></h5>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean egestas magna at
                                        porttitor vehicula nullam augue ipsum dolor.</p>
                                </div>
                            </div>
                    ...
                    <div class="mt-5 text-center">
                        <a class="btn btn-style" href="#services">Learn More Services</a>
                    </div>
                </div>
            </div>
            <!-- balloon animation -->
    ...
    <!-- testimonials -->
    <section class="w3l-clients-1" id="testi">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 float-rt text-md-right align-items-center mt-md-0 mt-4">
                        <ul class="buttons">
                            ...
                            <li><a href="#contact" class="btn btn-style">Get in touch</a> </li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- contact -->
    <section class="w3l-w3l-contacts-12 py-5" id="contact">
        <div class="contact-top py-md-5 py-4">
            <div class="container">
                ...
                <div class="wrapper-full">
                    <div class="line"></div>
                    <h3 class="title-style text-center mb-4">Contact Info</h3>
                    <div class="contact">
                        ...
                        <p class="contact-text-sub">London,</p>
                        <p class="contact-text-sub">75 West Rock, Maple Building</p>
