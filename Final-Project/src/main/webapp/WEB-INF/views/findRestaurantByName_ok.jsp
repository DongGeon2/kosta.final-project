        ...
        <section class="w3l-breadcrumb">
            <div class="container">
                ...
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span>식당추천</li>
                </ul>
            </div>
        </section>
    </div>
                ...
                <div class="col-lg-4 col-md-6 item">
                    <div class="card">
                        ...
                        <div class="card-body blog-details">
                            <span class="label-blue">${restaurantVO.resName}</span>
                            <a href="single.html" class="blog-desc">${restaurantVO.resInfo}
                            </a>
                            <div class="author align-items-center mt-3 mb-1">
                                <img src="assets/images/testi1.jpg" alt="" class="img-fluid rounded-circle" />
                                <ul class="blog-meta">
                                    <li>
                                        <a href="single.html">kk</a> </a>
                                    </li>
                    ...
                    <div class="col-lg-6 left-cont mb-lg-0 mb-5">
                        ...
                        <p class="mt-3 mb-2">${restaurantVO.resInfo}</p>
