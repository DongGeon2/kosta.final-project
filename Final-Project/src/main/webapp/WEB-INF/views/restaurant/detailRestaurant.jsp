...
<div class="inner-banner">
   <section class="w3l-breadcrumb">
      <div class="container">
         <h4 class="inner-text-title font-weight-bold text-white mb-sm-3 mb-2">Detail
            Restaurant</h4>
                  	...
                  	<c:choose>
                        <c:when test="${flag==true}">
                           <img data-state="like"
                              ...
                              alt="" class="img-fluid like" id="fullMyPickIcon">
                        </c:when>
                        <c:otherwise>
            ...
            <div class="pagination-style text-center mt-5 pt-5">
               <ul>
                  ...
                  <c:if test="${pb.previousPageGroup}">
                     <li><a disabled="" class="not-allowed"
                        href="/user/detailRestaurant?pageNo=${pb.startPageOfPageGroup-1}&resNo=${restaurantVO.resNo}">
                  ...
                  <c:forEach var="page" begin="${pb.startPageOfPageGroup}"
                     ...
                     <c:choose>
                        <c:when test="${pb.nowPage==page}">
                           <li><a class="active"
                              href="/detailRestaurant?pageNo=${page}&resNo=${restaurantVO.resNo}">${page}</a></li>
                        </c:when>
                        <c:otherwise>
                           <li><a
                              href="/detailRestaurant?pageNo=${page}&resNo=${restaurantVO.resNo}">${page}</a></li>
                  ...
                  <c:if test="${pb.nextPageGroup}">
                     <li><a
                        href="/detailRestaurant?pageNo=${pb.endPageOfPageGroup+1}&resNo=${restaurantVO.resNo}">
