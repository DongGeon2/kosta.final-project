    ...
    <section class="w3l-text-6">
        <div class="text-6-mian bottom-space py-5">
            <div class="container py-md-5 py-4">
                ...
                <c:forEach items="${requestScope.restaurantVOList}" var="vo" varStatus="status">
                ...
                <div class="col-lg-4 col-md-6 item">
                    <div class="card">
                        ...
                        <div class="card-body blog-details">
                            <span class="label-blue">${vo.resName}</span>
                            <a href="single.html" class="blog-desc">${vo.resInfo}
                            </a>
