        ...
        <div class="contact-top py-md-5 py-4">
            <div class="container">
                ...
                <div class="contacts12-main">
                    <form action="${pageContext.request.contextPath}/user/posting" method="post" class="main-input">
                        <div class="top-inputs d-grid">
                            <input type="text" placeholder="Title" name="boardTitle" id="w3lName" required="">
                        </div>
                       <!--  <input type="text" placeholder="Picture" name="w3lName" id="w3lName" required=""> -->
                        <textarea placeholder="Content" name="boardContent" id="w3lMessage" required=""></textarea>
